            ...
            foreach (Control child in parent.Controls)
            {
                ...
                switch (child.GetType().Name)
                {
                    ...
                    case "CheckBox":
                        ...
                        break;
                    /*
                    case "MaterialSingleLineTextField":
                        child.Text = GetSetting(app_name, child.Name, child.Text).ToString();
                        break;

                    case "MaterialCheckBox":
                        MaterialCheckBox mchk = child as MaterialCheckBox;
                        mchk.Checked = bool.Parse(GetSetting(app_name,
                            child.Name, mchk.Checked.ToString()).ToString());
                        break;
                    case "MaterialRadioButton":
                        MaterialRadioButton mrb = child as MaterialRadioButton;
                        mrb.Checked = bool.Parse(GetSetting(app_name,
                            child.Name, mrb.Checked.ToString()).ToString());
                        break;
                    */
                    case "RadioButton":
