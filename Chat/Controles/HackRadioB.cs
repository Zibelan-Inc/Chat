...
namespace Chat.Controles
{
    class HackRadioB : ThemeControl
    {
        ...
        private void InvalidateControls()
        {
            ...
            {
                if (!ReferenceEquals(C, this) && C is HackRadioB)
                {
                    ((HackRadioB)C).Checked = false;
                }
            }
        }
        ...
        protected override void PaintHook()
        {
            ...
            if (_Checked)
            {
                ...
                G.FillEllipse(new SolidBrush(Color.FromArgb(7, 164, 245)), new Rectangle(5, 5, 6, 6));
            ...
            {
                G.FillEllipse(new SolidBrush(Color.FromArgb(20, Color.FromArgb(7, 164, 245))), 5, 5, 6, 6);
            }
        ...
        public HackRadioB()
        {
            ...
            SetColor("Text", base.ForeColor);
            SetColor("Circle", Color.FromArgb(7, 164, 245));
            SetColor("Inner", Color.FromArgb(7, 164, 245));
        }
    }
